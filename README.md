...
class Carla:
    def __init__(self):
        self.nome = "Carla Vicktória de Almeida Santana Palmiere"
        self.formacao = "Engenharia de Software - UniCEUB (2º semestre)"
        self.papel = "Desenvolvedora Full Stack"
        self.localizacao = "Brasília, DF"
        self.idiomas = ["Português", "Inglês (Intermediário)"]

    def foco(self):
        return "Aprofundar conhecimento nas tecnologias que já uso"

    def destaque(self):
        return "Embaixadora Estudantil do Google 2026"
